...
- `LongTermDiscountStrategy` — 10% off for rentals of 7+ days
- `PricingSelector` — chooses the first applicable strategy

**Why:** invoice amounts can change (standard vs long-term discount) without
editing `PaymentService`. New pricing rules are new strategy classes.
